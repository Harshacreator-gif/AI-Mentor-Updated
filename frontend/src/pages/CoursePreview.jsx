...
export default function CoursePreview() {
  ...
  if (!courseData) {
    return <div className="min-h-screen bg-[#F6F8FA] flex items-center justify-center"><div className="text-center"><div className="animate-spin rounded-full h-12 w-12 border-b-2 border-blue-600"></div><p className="mt-4 text-gray-600">Loading course details...</p></div></div>;
  }
          ...
          <div className="flex-1 w-full lg:max-w-[821px]">
              ...
              <div className="flex flex-wrap items-center gap-4 lg:gap-6">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-[#6B7280] text-sm">
                    Created by <span className="text-[#FF6C34]">{courseData.instructor}</span>
                  </span>
                </div>
            ...
            <section className="bg-white rounded-xl p-4 lg:p-6 mb-8 shadow-[0_0_30px_0_rgba(102,126,234,0.3)]">
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 lg:gap-6">
                ...
                <div className="text-center">
                  <div className="text-[#C084FC] text-2xl font-bold mb-1">{courseData.students.toLocaleString()}</div>
                  <div className="text-[#9CA3AF] text-base">Students enrolled</div>
                </div>

                <div className="text-center">
                  <div className="text-[#60A5FA] text-2xl font-bold mb-1">{courseData.duration}</div>
